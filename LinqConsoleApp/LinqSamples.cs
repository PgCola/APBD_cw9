...
namespace LinqConsoleApp
{
    public class LinqSamples
    {
        ...
        */
        ...
        {
            var res = Emps.Select(emp => emp.Salary).Max();
        }
        ...
        {
            bool hasBackendProgrammer = Emps.Where(b => b.Job == "Backend programmer")
                                            .ToList().Capacity > 0;
        }
        ...
        {
            var res = Emps.Aggregate(0, (max, next) =>
                (next.Salary >= max ? max = next.Salary : max));
        }
        ...
        public void Przyklad12()
        {
            ...
            {
                Debug.WriteLine(r.dept + " | " + r.employee);
            }
        }
    }
}